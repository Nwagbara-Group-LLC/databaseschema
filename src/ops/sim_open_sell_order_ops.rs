...
pub async fn get_sim_open_sell_orders(pool: Arc<Pool<CustomAsyncPgConnectionManager>>) -> Result<Vec<SimOpenSellOrder>, Error> {
...
pub async fn get_sim_open_sell_orders_by_symbol(pool: Arc<Pool<CustomAsyncPgConnectionManager>>, sym: &str) -> Result<Vec<SimOpenSellOrder>, Error> {
    println!("Getting open sell orders");
    use crate::schema::sim_open_sell_orders::dsl::*;
