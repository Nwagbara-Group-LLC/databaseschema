...
SELECT create_hypertable('sim_open_sell_orders', 'created_at', chunk_time_interval => interval '1 day');
...
SELECT add_compression_policy('sim_open_sell_orders', INTERVAL '1 day');

-- Keep backtest data for 90 days
SELECT add_retention_policy('sim_open_sell_orders', INTERVAL '90 days');
